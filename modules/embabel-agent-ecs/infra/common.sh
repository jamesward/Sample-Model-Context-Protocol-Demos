...
export DEFAULT_BASE_STACK_NAME="${BASE_STACK_NAME:-embabel-agent-base}"
export DEFAULT_SERVICES_STACK_NAME="${SERVICES_STACK_NAME:-embabel-agent-services}"
export DEFAULT_CLUSTER_NAME="${CLUSTER_NAME:-${DEFAULT_BASE_STACK_NAME}-cluster}"

# ECR configuration
export ECR_REPO_PREFIX="embabel-agent"
